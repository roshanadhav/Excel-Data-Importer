...
const EmailVerify = () => {
  ...
  const email = localStorage.getItem("email") || "your email"; // Fetch email from localStorage or context
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/auth/verify-account`, { email, otp: otpCode });
