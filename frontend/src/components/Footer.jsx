  ...
  return (
    <footer className="bg-gray-10 text-gray-700 py-8 px-6 sm:px-16">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8">
        ...
        {/* About Section */}
        <div>
          <h2 className="text-xl font-bold text-gray-900">Excel Data Importer</h2>
          <p className="mt-2 text-gray-600">
            A simple and powerful tool to upload and manage your Excel files effortlessly.
          </p>
        </div>
      ...
      <div className="mt-8 border-t border-gray-300 pt-6 flex flex-col sm:flex-row justify-between items-center">
        <p className="text-gray-600">© 2025 Excel Data Importer. All rights reserved.</p>
